...
<body> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Yarlit</a>
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2 @yield('home')"
                                    aria-current="page" href="/home"> <svg class="bi" aria-hidden="true">
                                        <use xlink:href="#house-fill"></use>
                                    </svg>
                                    Home
                                </a> </li>
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2 @yield('about')"href="/about">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 @yield('contact')" href="/contact">
                                    <i class="bi bi-person-lines-fill" aria-hidden="true"></i>
                                    Contacts
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 @yield('photo')" href="/photo">
                                    <i class="bi bi-image" aria-hidden="true"></i>
                                    Photos
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 @yield('elist')" href="/emplist">
                                    <i class="bi bi-people" aria-hidden="true"></i>
                                    Employee List
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 @yield('eform')" href="/form">
                        ...
                        <hr class="my-3">
                        <ul class="nav flex-column mb-auto">
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2" href="/emp"> <svg
                                        class="bi" aria-hidden="true">
